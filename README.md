...
|-----------------------|-----------------------------------------------------------|
| `sample_data/`              | Sample datasets for testing (small excerpts)              |
| `final_data/`         | Processed final dataset used by the dashboard              |
| `data_processing.ipynb` | Jupyter Notebook for processing and merging datasets   |
| `api_geocode.py`      | API call functions for geocoding                           |
| `streamlit_app.py`    | Streamlit dashboard code                                   |
| `.env.example`        | Example API key configuration file (no real keys)         |
